...
// export const setHttp = _http => http = _http;
...
var createModule = function createModule(moduleName) {
    ...
    var test = function test() {
        ...
        sas.forEach(function (_ref) {
            ...
            _assert2.default.deepEqual(reducer(initialState, action), newState, 'reducer' + ('(' + JSON.stringify(initialState)) + (', ' + JSON.stringify(action) + ') !== ') + ('' + JSON.stringify(newState)));
        });
    };
